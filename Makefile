...
termux:
	g++ main.cpp -D__ANDROID__ -shared -fPIC -lbox2d -lsfml-graphics -lsfml-system -lsfml-window -lsfml-activity -L /data/data/com.termux/files/home/prog/Box2d/and/lib/arm64-v8a/ -Wl,--whole-archive /data/data/com.termux/files/usr/lib/libsfml-main.a -Wl,--no-whole-archive  -o and/lib/arm64-v8a/liba.so	
apk:
	cd and&&make rlib
install:
	cd and&&make install
